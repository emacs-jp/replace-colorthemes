;;; subtle-blue-theme.el --- subtle-blue theme
...
;;; Commentary:
;;
;; Port of subtle-blue theme from `color-themes'

;;; Code:

(deftheme subtle-blue
  "subtle-blue theme")
...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "#4f657d" :foreground "gray80"))))
 '(mode-line-buffer-id ((t (:background "#4f657d" :foreground "gray80"))))
 '(mode-line-mousable ((t (:background "#4f657d" :foreground "gray80"))))
 '(mode-line-mousable-minor-mode ((t (:background "#4f657d" :foreground "gray80"))))
...
(provide-theme 'subtle-blue)

;;; subtle-blue-theme.el ends here
