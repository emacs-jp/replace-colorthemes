...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:foreground "cyan" :background "#007080"))))
 '(mode-line-buffer-id ((t (:foreground "cyan" :background "#007080"))))
 '(mode-line-mousable ((t (:foreground "cyan" :background "#007080"))))
 '(mode-line-mousable-minor-mode ((t (:foreground "cyan" :background "#007080"))))
