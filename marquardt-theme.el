...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "bisque2" :foreground "steelblue4"))))
 '(mode-line-buffer-id ((t (:background "bisque2" :foreground "blue4"))))
 '(mode-line-mousable ((t (:background "bisque2" :foreground "firebrick"))))
 '(mode-line-mousable-minor-mode ((t (:background "bisque2" :foreground "green4"))))
