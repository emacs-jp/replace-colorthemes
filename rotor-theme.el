...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "wheat" :foreground "DarkOliveGreen"))))
 '(mode-line-buffer-id ((t (:background "wheat" :foreground "DarkOliveGreen"))))
 '(mode-line-mousable ((t (:background "wheat" :foreground "DarkOliveGreen"))))
 '(mode-line-mousable-minor-mode ((t (:background "wheat" :foreground "DarkOliveGreen"))))
 '(nil ((t (nil))))
