...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "dodgerblue" :foreground "black" :overline "red" :underline "red"))))
 '(mode-line-buffer-id ((t (:background "dodgerblue" :foreground "black"))))
 '(mode-line-mousable ((t (:background "dodgerblue" :foreground "black"))))
 '(mode-line-mousable-minor-mode ((t (:background "dodgerblue" :foreground "black"))))
